...
#		print(fnn[0])
		...
		savestring = [FN,Rz,Lz,RHS,LHS,RTO,LTO,Rgorb,Lgorb,RHIPY-RANKY,LHIPY-LANKY,rsci,lsci,RHIPY,LHIPY,RANKY,LANKY,fakeTargetR,fakeTargetL]#organize the data to be written to file
