...
In version 1 rev5, feedback, cursor, are off.

Treadmill moves the feet back to neutral after a step

rev 5 introduces a randomized test of each leg. uses syntax random.randint(a,b) to determine which leg to test next
