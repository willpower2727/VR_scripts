<<<<<<< HEAD
﻿#This script is a test of a PI position controller, to see how accurate position placement can be with the treadmill
#WDA 2/18/2016
#
...
#			print(PC1Y)
		...
		if (startflag!=0):
			...
			while (abs(1.45-PC1Y) >= 0.001):
				
				lspeed = 600*abs(1.45-PC1Y) #P
				lspeed = int(lspeed*math.copysign(1,1.45-PC1Y))
				speedlist = [0,lspeed,1300,1300,0]
				qq.put(speedlist)
				#generate MJT
