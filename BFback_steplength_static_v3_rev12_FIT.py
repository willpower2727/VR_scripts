...
rev12 introduces a new initial condition for the beginning of each attempt. Now the legs are not tied in position at the beginning. Rather the contralateral leg is forward.
wda 2/5/2015
"""
import viz
import vizshape
