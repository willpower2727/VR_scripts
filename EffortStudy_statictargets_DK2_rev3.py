...
#print('distLZ: ',distLZ,' wideLX: ',wideLX)
...
#		print('RANKY: ',RANKY, ' LANKY: ',LANKY)
		...
		cursorR.setScale(0.1,(LANKY-RANKY)*rscale,0.0125)
		cursorL.setScale(0.1,(RANKY-LANKY)*lscale,0.0125)
		#RHS
...
def savedata(savestring,q3):
	...
	mst = time.time()
	mst2 = int(round(mst))
	mststring = str(mst2)+'EffortStudy_static_DK2_R3.txt'
