...
# 
#
#Rev 4 uses boring colors for stuff, and prints out the score at each gait event detected
#
#Use V2P_DK2_R1
...
cursorR = viz.add('box3.obj', scale=[0.65*(0.2+wideRX),0.01*rscale,0.001], cache=viz.CACHE_NONE)
...
cursorL = viz.add('box3.obj', scale=[0.65*(0.2+wideLX),0.01*lscale,0.001], cache=viz.CACHE_NONE)
...
#		print('RANKY: ',RANKY, ' LANKY: ',LANKY)
		...
		cursorR.setScale(0.65*(0.2+wideRX),(LANKY-RANKY)*rscale,0.001)
		cursorL.setScale(0.65*(0.2+wideLX),(RANKY-LANKY)*lscale,0.001)
		#RHS
