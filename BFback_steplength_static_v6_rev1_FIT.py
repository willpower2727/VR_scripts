...
V6 is the evaluation method of V4, displaying nothing except instruction on which steps to take

In version 6 feedback, cursor and targets are off.
rev1 
