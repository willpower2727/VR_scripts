...
The treadmill uses forceplate and vicon data to move feet back to neutral position

revision 4 incorporates the footprint as the history marker, instead of the bar
"""
import viz
import vizshape
import time
