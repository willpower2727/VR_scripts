...
#REV 2 highlights a target based on a predefined order of targets. Targets are no longer fixed on one value for the whole trial
#
#V2P_DK2_R1
#
#William Anderton 4/15/2016
...
def savedata(savestring,q3):
	...
	mst = time.time()
	mst2 = int(round(mst))
	mststring = str(mst2)+'EXP2B_V8_rev2_DK2.txt'
