#Stridetime rev9 is the same as rev8 except with updates to saving and streaming
#WDA 1/17/2017
...
global cpps
cpps = subprocess.Popen('"C:/Users/Gelsey Torres-Oviedo/Documents/Visual Studio 2013/Projects/Vicon2Python_rev4/x64/Release/Vicon2Python_rev4.exe"')
time.sleep(4)
...
global scalorxx
scalorxx = 0.6667
global targetL #targetL height
targetL = 1
global targetR #targetR height
targetR = 1
global targettol
targettol = 0.05
global boxL #boxL definition
...
HistBallR.alpha(0.8)
global HistBallL #footprintL definition
...
viz.MainView.setPosition(0, 0.5, -1.5) #main view position and scale
...
#		print(fnn[0])
		...
		savestring = [FrameNum,Rz,Lz,RHS,LHS]
...
def savedata(savestring,q3):
	...
	mst = time.time()
	mst2 = int(round(mst))
	mststring = str(mst2)+'StrideTimerev9_Nico.txt'
	print("Data file created named:")
	print(mststring)
	file = open(mststring,'w+')
	csvw = csv.writer(file)
	csvw.writerow(['FrameNumber','Rfz','Lfz','RHS','LHS'])
	file.close()
