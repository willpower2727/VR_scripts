...
In version 3 rev4, feedback, cursor, and target are on.

Treadmill moves the feet back to neutral after a step

rev 4 introduces a randomized test of each leg. uses syntax random.randint(a,b) to determine which leg to test next
