...
Uses cylinder instead of box hallway
...
OF1 = viz.addChild('OpticFlowCylinder1.osgb',scale=[3,3,3])
OF1.disable(viz.LIGHTING)
OF1.collideSphere()

OF2 = viz.addChild('OpticFlowCylinder1.osgb',scale=[3,3,3])
OF2.disable(viz.LIGHTING)
OF3 = viz.addChild('OpticFlowCylinder1.osgb',scale=[3,3,3])
...
#add a light to the cylinder to remove odd shadows
#light = viz.addLight()
#light.enable()
