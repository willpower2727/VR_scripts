...
for x in range(1,5,1):
	...
	print(randy)
	frodo = frodo+[randy[0]]*50
	frodo = frodo+[randy[1]]*50
	frodo = frodo+[randy[2]]*50
...
#			targetnum = updatetargetdisplay(Lgamma,circleL,1)
		...
		histzL = Lz
		#save data
		savestring = [FN,Rz,Lz,RHS,LHS,RANKY,LANKY,rgorb,lgorb,Rgamma,Lgamma,Rerror,Lerror,targetmean+frodo[stepind],samwise[stepind],]#organize the data to be written to file
		q3.put(savestring)
...
def savedata(savestring,q3):
	...
	mst = time.time()
	mst2 = int(round(mst))
	mststring = str(mst2)+'EXP2B_V7_rev2_DK2.txt'
	print("Data file created named: ")
	print(mststring)
	file = open(mststring,'w+')
	json.dump(['FrameNumber','Rfz','Lfz','RHS','LHS','RANKY','LANKY','RGORB','LGORB','Rgamma','Lgamma','Rerror','Lerror','target','cursorvisibility'],file)
	file.close()
