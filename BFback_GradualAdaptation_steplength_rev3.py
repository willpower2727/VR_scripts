...
#revision 3 changes from rev 2 by changing the footprint to gold bar, and by printing target values to the command line, and allowing the option of
#displaying specified target values for the first 12-13 steps, for post-catch adaptation.
