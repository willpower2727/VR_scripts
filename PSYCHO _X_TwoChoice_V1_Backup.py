...
#			#########################################
			...
			histzL = Lz
			#save data
			savestring = [FN,Rz,Lz,RHS,LHS,rgorb,lgorb,RANKY-LANKY,LANKY-RANKY,Ralpha,Lalpha,Rx,Lx,RANKY,LANKY,RGT,LGT,phaxxe, PSYCHO, targetAmean, targetXmean, frodo[stepind], time.time()]#organize the data to be written to file
			q3.put(savestring)
#			timeold = time.time()
	cpps.kill()
#	q3.join()
...
#	savestring = [FN,Rz,Lz,RHS,LHS,rgorb,lgorb,RANKY-LANKY,LANKY-RANKY,Ralpha,Lalpha,Rx,Lx,RANKY,LANKY,RGT,LGT,phaxxe, PSYCHO, targetAmean, targetXmean, frodo, time]
	csvw.writerow(['FrameNumber','Rfz','Lfz','RHS','LHS','rgorb','lgorb','rgamma','lgamma','Ralpha','Lalpha','Rx','Lx','RANK','LANK','RHIP','LHIP','phase', 'PSYCHO', 'targetAmean', 'targetXmean', 'frodo', 'time'])
	file.close()
