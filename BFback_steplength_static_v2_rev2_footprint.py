...
In version 2 rev2, no feedback, but cursor and target are on.
...
global HistBallR
HistBallR = viz.add('footprint.obj', color=viz.YELLOW, scale=[0.02,0.02,0.1], cache=viz.CACHE_NONE)
HistBallR.setPosition([0.2,targetR+0.01,0])
...
global HistBallL
HistBallL = viz.add('footprint.obj', color=viz.YELLOW, scale=[0.02,0.02,0.1], cache=viz.CACHE_NONE)
HistBallL.setPosition([-0.2,targetL+0.01,0])
HistBallL.alpha(0.8)
