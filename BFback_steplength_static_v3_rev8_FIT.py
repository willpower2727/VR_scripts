...
In version 3 rev8, feedback, cursor, and target are on.

Treadmill moves the feet back to neutral after a step

rev8 introduces a 3d animation of the target exploding when step length is within tolerance. The fireworks in rev 7 were a video, in rev8 it's a 3d animation
