<<<<<<< HEAD
﻿""" Step Length Biofeedback familiarization task, Version 4, uses DK2

A subject stands in a pre-step pose where alpha and X are defined. Experimental piloting only
