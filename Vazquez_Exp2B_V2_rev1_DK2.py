...
#
#V2 is a training version where subjects see the right leg feedback.
#
#V2P_DK2_R1
#
#William Anderton 1/22/2015
...
circleL.setPosition(-0.03,targetSLOW,0)
...
circleR.setPosition(0.04,targetFAST,0)
...
viz.MainView.setPosition(0, 0.25, -0.57)
...
nothing = updatetargetdisplay(targetFAST,circleR,2)
...
#		print("RANKY",RANKY)
		...
		if (Rz <= -30) & (histzR > -30):#RHS
			...
			if (Rerror < targettol):
				...
				rgorb = 0
			nothing = updatetargetdisplay(Ralpha,circleR,2)
		else:
			RHS = 0
...
def savedata(savestring,q3):
	...
	mst = time.time()
	mst2 = int(round(mst))
	mststring = str(mst2)+'EXP2B_DK2_V2.txt'
