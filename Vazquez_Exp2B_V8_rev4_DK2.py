...
#
#V8 is a test version of V7, no feedback is displayed
#REV 4 uses Alpha and a percentage of the target for feedback
#
#V2P_DK2_R1
#
...
#			targetnum = updatetargetdisplay(Lgamma,circleL,1)
		...
		histzL = Lz
		#save data
		savestring = [FN,Rz,Lz,RHS,LHS,RANKY,LANKY,RHIPY,LHIPY,rgorb,lgorb,Ralpha,Lalpha,Rerror,Lerror,targetmean+frodo[stepind],]#organize the data to be written to file
		q3.put(savestring)
...
def savedata(savestring,q3):
	...
	mst = time.time()
	mst2 = int(round(mst))
	mststring = str(mst2)+'EXP2B_V8_rev4_DK2.txt'
	print("Data file created named: ")
	print(mststring)
	file = open(mststring,'w+')
	csvw = csv.writer(file)
	csvw.writerow(['FrameNumber','Rfz','Lfz','RHS','LHS','RANKY','LANKY','RHIPY','LHIPY','RGORB','LGORB','Ralpha','Lalpha','Rerror','Lerror','target'])
