...
The treadmill will slowly move the displaced foot back to a neutral position...
...
boxL.setPosition([-0.2,(targetL-targettol)-.01,0.05])

global boxR
boxR = viz.addChild('target.obj',color=(0.063,0.102,0.898),scale=[0.1,targettol,0.0125])
boxR.setPosition([0.2,(targetR-targettol)-.01,.05])
