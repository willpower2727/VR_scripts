...
rev18 displays on the HMD, static, non updating viewpoint
...
#			Rz = float(tempdat[3])
#			Lz = float(tempdat[2])
#			RHIPY = float(tempdat[6])/1000
#			LHIPY = float(tempdat[8])/1000
#			RANKY = float(tempdat[7])/1000
#			LANKY = float(tempdat[9])/1000
#			print(RANKY)
...
def savedata(savestring,q3):
	...
	mst = time.time()
	mst2 = int(round(mst))
	mststring = str(mst2)+'DK2rev18V3.txt'
