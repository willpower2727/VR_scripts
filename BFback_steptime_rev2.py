...
boxL.setPosition([-0.2,(targetL-targettol)-0.01,0.05])#target box needs to be a little offset from pure target altittude since perspective can make biofeedback seem dishonest, good feedback appears when it looks like value is outside target box

global boxR
boxR = viz.addChild('target.obj',color=(0.063,0.102,0.898),scale=[0.1,targettol,0.0125])
boxR.setPosition([0.2,(targetR-targettol)-0.01,0.05])
