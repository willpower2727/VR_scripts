...
#revision 4 starts to keep track of the last 12 steps' scale factors and a report is given at the end so if the program is restarted you can preserve the last scales used with catchflag
#2/2/2015
