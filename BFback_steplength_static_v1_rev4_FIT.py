...
Treadmill uses forceplate and vicon data to move the foot back to neutral position, hence FIT version

revision 4 incorporates the history marker being displayed as a foot print instead of a bar
